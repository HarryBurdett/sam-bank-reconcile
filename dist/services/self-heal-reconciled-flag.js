...
export async function selfHealBalanceMatch(operaDb, appDb, bankCode, opts = {}) {
    ...
    const nbank = (await operaDb('nbank')
        ...
        .first());
    if (!nbank)
        return { promoted: false, reason: 'bank_not_found' };
...
//# sourceMappingURL=self-heal-reconciled-flag.js.map